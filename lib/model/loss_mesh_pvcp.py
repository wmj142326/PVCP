...
class MeshLoss(nn.Module):
    ...
    def forward(
        ...
        # loss_dict['loss_3d_acc'] = loss_acceleration(preds_local, gt_local)
        ...
        preds_class = smpl_class # (64,16,4)
        gt_class = sensor_gt['pose_class'] # (64,16)
        loss_dict['loss_class'] = loss_pose_class(preds_class, gt_class)
